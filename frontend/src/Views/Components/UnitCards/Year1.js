    ...
    return (
        <Box className={classes.root}>
            <ButtonGroup className={classes.group} variant="contained" aria-label="contained primary button group">
                <Link className={classes.link} to="/projects/year4/adta"><Button className={classes.button}>Applied Data and Text Analytics</Button></Link>
                <Link className={classes.link} to="/projects/year4/scicom"><Button className={classes.button}>Scientific computing and simulation</Button></Link>
                <Link className={classes.link} to="/projects/year4/pp"><Button className={classes.button}>Parallel Programming</Button></Link>
                <Link className={classes.link} to="/projects/year4/comvi"><Button className={classes.button}>Computer Vision</Button></Link>
                <Link className={classes.link} to="/projects/year4/grip"><Button className={classes.button}>Industrial Project</Button></Link>
            </ButtonGroup>
            <Switch>
